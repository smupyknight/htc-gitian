...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'htc-build', autostart: false do |gitian|
...
#    gitian.vm.synced_folder "./htc-binaries", "/home/vagrant/htc-binaries", create: true
    gitian.vm.post_up_message = "HTC deterministic build environment started."
  end
